    ...
    Private Sub BtnGrabar_Click(sender As Object, e As EventArgs) Handles BtnGrabar.Click
        Try
            If (Me.ValidateChildren = True And TxtNombre.Text <> "") Then
                Dim ObjProveedor As New Entidades.Persona
                Dim NegProveedor As New Negocio.NegocioPersona
                ObjProveedor.TipoPersona = "Proveedor"
                ObjProveedor.Nombre = TxtNombre.Text
                ObjProveedor.TipoDocumento = CmbTipo.Text
                ObjProveedor.Direccion = TxtDireccion.Text
                ObjProveedor.Telefono = TxtTelefono.Text
                ObjProveedor.Email = TxtEmail.Text
                ObjProveedor.NumDocumento = TxtNumDocumento.Text
                If (NegProveedor.Insertar(ObjProveedor)) Then
                    MsgBox("El Proveedor se grabó correctamente", MsgBoxStyle.Information, "Datos Ingresados")

                    Me.Listar()
                Else
                    MsgBox("No se pudo registrar el Proveedor", MsgBoxStyle.Critical, "ERROR..")
                End If
    ...
    Private Sub BtnActualizar_Click(sender As Object, e As EventArgs) Handles BtnActualizar.Click
        Try
            If (Me.ValidateChildren = True And TxtNombre.Text <> "" And TxtId.Text <> "") Then
                Dim ObjProveedor As New Entidades.Persona
                Dim NegProveedor As New Negocio.NegocioPersona
                ObjProveedor.IdPersona = TxtId.Text
                ObjProveedor.Nombre = TxtNombre.Text
                ObjProveedor.TipoDocumento = CmbTipo.Text
                ObjProveedor.Direccion = TxtDireccion.Text
                ObjProveedor.Telefono = TxtTelefono.Text
                ...
                ObjProveedor.NumDocumento = TxtNumDocumento.Text
                ObjProveedor.TipoPersona = "Proveedor"
                If (NegProveedor.Actualizar(ObjProveedor)) Then
                    MsgBox("El Proveedor se actualizó correctamente", MsgBoxStyle.Information, "Datos Actualizados")

                    Me.Listar()
                Else
                    MsgBox("No se pudo actualizar el Proveedor", MsgBoxStyle.Critical, "ERROR..")
                End If
